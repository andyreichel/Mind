...
public class JsonParserForSonarApiResponsesTest {
	@Test
	public void test_getDateOfLastSonarAnalyse_successFull()
	{
	...
	public void test_getMapOfAllVersions_notValidJson()
	{
		String testJson = "garbage";
	...
	@Test
	public void test_getNloc_successfull()
	{
	...
	@Test(expected=JSONException.class)
	public void test_getNloc_notFoundMetric()
	{
	...
	@Test(expected=JSONException.class)
	public void test_getNloc_invalidJson()
	{
		String testJson = "]";
	...
	@Test(expected=JSONException.class)
	public void test_getNloc_emptyJson()
	{
		String testJson = "[]";
	...
	@Test
	public void test_getNumberOfViolationsOfSpecificRuleForResource()
	{
